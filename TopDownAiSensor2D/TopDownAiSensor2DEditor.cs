...
// I recommend to put this script inside "Editor" folder
...
public class TopDownAiSensor2DEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        DefaultScriptField(MonoScript.FromMonoBehaviour((MonoBehaviour)target));
        ...
        {
            PropertySliderField(viewOuterRadius, 0, 20, ViewOuterRadiusContent);
            PropertySliderField(viewInnerRadius, 0, 10, ViewInnerRadiusContent);
            PropertySliderField(viewAngle, 0, 360, ViewAngleContent);
            ...
            {
                PropertySliderField(safeZoneRadius, 0, 10, SafeZoneRadiusContent);
                PropertySliderField(attackRangeRadius, 0, 10, AttackRangeRadiusContent);
            }
            EditorGUILayout.EndFadeGroup();
            EditorGUILayout.Space();

            PropertySliderField(sensorTick, 0.001f, 1, SensorTickContent);
        ...
        {
             PropertySliderField(thickness, 0.5f, 2, default);
    ...
    #region GUI (FIELD OF VIEW) RELATED METHODS
    /// <summary>
    ...
    #region INSPECTOR UTILS METHODS
    /// <summary>
    /// Default "script" object field
    /// </summary>
    /// <param name="target"> target object </param>
    private static void DefaultScriptField(Object target)
    {
        EditorGUI.BeginDisabledGroup(true);
